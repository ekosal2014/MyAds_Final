					...
					<div class="x_panel">
						...
						<div class="x_content">
							...
							<div class="wrap_func">
								...
								<div class="register">
									<form method="post" action="addsubcate.adm" name="frmsubcategory">
										<table summary="">
											<caption></caption>
											<colgroup>
											...
											<tbody>
												...
												<tr>
													...
													<td><div><input type="text" value="" class="t_css" placeholder="Enter sub category name" name="txt_cls_name" style="width:100%;" required="required"></div></td>
												</tr>
												<tr>
													<th><div>Sub Category Name <span class="require">*</span></div></th>
													<td><div><input type="text" value="" placeholder="Enter sub category name" name="txt_subcate_name" style="width:100%;" required="required"></div></td>
												</tr>
												<tr>
												...
												<tr>
													<th colspan="2" class="t_right"><div><!-- <a href="javascript:addsubcate()" class="btn_create">Add My Category</a> --><input type="submit" value="Add My Category" class="btn_create"></div></th>
												</tr>
											</tbody>
										</table>
									</form>

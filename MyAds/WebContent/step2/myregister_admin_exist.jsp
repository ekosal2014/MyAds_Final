<%@page import="myads.model.dto.UserDto"%>
...
<%
	UserDto myuser=(UserDto)request.getAttribute("result");
%>
					...
					<div class="x_panel">
						...
						<div class="x_content">
							...
							<div class="wrap_func">
								...
								<div class="register">
									<form method="post" action="" name="frmregister">
										<table summary="">
											<caption></caption>
											<colgroup>
											...
											<tbody>
												...
												<tr>
													...
													<td><div><input type="text" value="<%= myuser.getName() %>" placeholder="Enter your name" name="txt_name" style="width:100%;" required="required"></div></td>
												</tr>
												<tr>
													...
													<td>
														<div>
															<select style="width:100%;" name="txt_cateid" required="required">
																...
																%>
																<option value="<%= myuser.getId() %>" selected="selected"><%= myuser.getPositionAs() %></option>
															</select>
														</div>
													</td>
												</tr>
												...
												<tr>
													...
													<td><div><input type="text" value="<%= myuser.getDob() %>" placeholder="Enter you date of birth. ex: 01/01/1991" name="txt_dob" style="width:100%;" required="required"></div></td>
												</tr>
												<tr>
													<th scope="col"><div>Change Password <span class="require">*</span></div></th>
													<td><div><input type="password" value="<%= myuser.getPassword() %>" placeholder="Create password" name="txt_pass" style="width:100%;" required="required"></div></td>
												</tr>
												<tr>
												...
												<tr>
													...
													<td><div><input type="text" value="<%= myuser.getEmail() %>" placeholder="Enter your email address" name="txt_email" style="width:100%;" required="required"></div></td>
												</tr>
												<tr>
													<th scope="col"><div>Phone Number <span class="require">*</span></div></th>
													<td><div><input type="text" value="<%= myuser.getPhone() %>" placeholder="Enter your phone number" name="txt_phone" style="width:100%;" required="required"></div></td>
												</tr>
												<tr>
													<th scope="col"><div>Your Address <span class="require">*</span></div></th>
													<td><div><textarea style="width:100%;height:70px;" placeholder="Enter your real current address" name="txt_address" class="t_c777" required="required"><%= myuser.getAddress() %></textarea></div></td>
												</tr>
												<tr>
													<th colspan="2" class="t_right" scope="col"><div><!-- <a href="javascript:register()" class="btn_create">Create My Account</a> --><input type="submit" value="Save My Account" class="btn_create"></div></th>
												</tr>
											</tbody>
										</table>
									</form>

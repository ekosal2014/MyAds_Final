	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				...
				<div class="x_title">
					<h2>All Roles <small><a href="layad_role.adm" class="btn_create">Add New</a></small></h2>
				...
				<!-- x_content -->
				<div class="x_content">
					<form action="save_role.adm" method="post">
						<table class="mytable">
							<colgroup>
							...
							<tbody>
								<%
									ResultSet rs=MyComobox.getlistRole();
									while(rs.next()){
								%>
								<tr class="gradeU">
									...
									<td>
										<div align="center">
											<a href="layexist_role.adm?id=<%= rs.getString(1) %>"><i class="t_g">edit</i></a>&nbsp;&nbsp;&nbsp;

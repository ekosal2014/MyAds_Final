	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				...
				<div class="x_title">
					<h2>All Users <small><a href="layad_adm_acc.adm" class="btn_create">Add New</a></small></h2>
						...
						<table class="mytable">
							...
							<thead>
								<tr>
									...
									<th scope="col"><div align="center">Sex</div></th>
									<th scope="col"><div align="center">DOB</div></th>
							...
							<tbody>
								<%
									ResultSet rs=MyComobox.getlistUser();
									while(rs.next()){
								%>
								<tr class="gradeU">
									...
									<td>
										<div align="center">
											<a href="layexist_acc.adm?id=<%= rs.getString(1) %>"><i class="t_g">edit</i></a>&nbsp;&nbsp;&nbsp;

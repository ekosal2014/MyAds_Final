	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				...
				<div class="x_title">
					<h2>All Main Categories <small><a href="layad_maincate.adm" class="btn_create">Add New</a> </small></h2>
						...
						<table class="mytable">
							...
							<thead>
								<tr>
									...
									<th scope="col"><div>Icon Class Name</div></th>
							...
							<tbody>
								<%
									ResultSet rs=MyComobox.getlistCategory();
									while(rs.next()){
								%>
								<tr class="gradeU">
									<td><div align="center"><%= rs.getString(1) %></div></td>
									<td><div><span class="t_css"><%= rs.getString(2) %></span> &nbsp;&nbsp;&nbsp; <%= rs.getString(3) %></div></td>
									<td><div class="t_c777"><%= rs.getString(4) %></div></td>
									<td><div align="center"><%= rs.getString(5) %></div></td>
									<td>
										<div align="center">
											<a href="layexit_maincate.adm?id=<%= rs.getString(1) %>"><i class="t_g">edit</i></a>&nbsp;&nbsp;&nbsp;
											<a href="maincate_delete.adm?id=<%= rs.getString(1) %>"><i class="t_r">delete</i></a>
										</div>
									</td>
								</tr>
								<%

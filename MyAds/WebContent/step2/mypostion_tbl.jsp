	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				...
				<div class="x_title">
					<h2>All Positions <small><a href="layad_postion.adm" class="btn_create">Add New</a></small></h2>
						...
						<table class="mytable">
							...
							<thead>
								<tr>
									...
									<th scope="col"><div>Role Name</div></th>
									<th scope="col"><div>Position As</div></th>
							...
							<tbody>
								<%
									ResultSet rs=MyComobox.getlistPosition();
									while(rs.next()){
								%>
								<tr class="gradeU">
									...
									<td>
										<div align="center">
											<a href="layexist_position.adm?id=<%= rs.getString(1) %>"><i class="t_g">edit</i></a>&nbsp;&nbsp;&nbsp;
